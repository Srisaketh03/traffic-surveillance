...
main = tkinter.Tk()
main.title("Real Time Traffic Surveillance and Detection with Deep Learning and Computer Vision")
...
font = ('times', 16, 'bold')
title = Label(main, text='Real Time Traffic Surveillance and Detection with Deep Learning and Computer Vision')
